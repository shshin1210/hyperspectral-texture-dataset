...
t_write_tif(uint8(cube*(2^8-1)),'T01-uint8-EE.tif','tumb',uint8(RGB_EE*(2^8-1)),'datatype','uint8');
...
t_write_tif(uint16(cube*(2^16-1)),'T01-uint16-triangular.tif','tumb','triangular','datatype','uint16');
